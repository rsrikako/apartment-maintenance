        ...
        {isAdmin && (
          <div className="flex flex-col items-center">
            <button
              ...
              title={showAdd ? "Cancel" : "Add Flat"}
            >
              <span className="text-2xl">➕</span>
            </button>
            <span className="text-xs mt-1 text-gray-700 font-medium">Add Flat</span>
          </div>
        )}
        <div className="flex flex-col items-center">
          <button
          ...
          <span className="text-xs mt-1 text-gray-700 font-medium">Admins</span>
        </div>
      </div>
      {showAdd && isAdmin && (
        <form
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-4 mt-4">
          {flats.map((flat) => (
            <div
              key={flat.id}
              className="bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col items-center border border-blue-200 w-full sm:max-w-xs mx-auto group relative transition-all duration-200 hover:shadow-2xl"
            >
              {/* Top image section */}
                  ...
                  <div className="flex flex-col items-center w-full mb-1">
                    <div className="flex items-center justify-center gap-x-2 w-full">
                      ...
                      <span
                        ...
                        title={flat.ownerUid && userDetailsMap[flat.ownerUid]?.name ? userDetailsMap[flat.ownerUid]?.name : flat.ownerUid || ""}
                      >
                        {flat.ownerUid && userDetailsMap[flat.ownerUid]?.name ? userDetailsMap[flat.ownerUid]?.name : flat.ownerUid || ""}
                      </span>
                    </div>
                    <div className="flex flex-row items-center justify-center gap-x-2 mt-1 w-full">
                      <button
                        className="flex items-center justify-center bg-gray-100 text-gray-700 rounded-full shadow hover:bg-gray-200 transition w-10 h-10"
                      ...
                      <a
                        href={`tel:${flat.ownerUid && userDetailsMap[flat.ownerUid]?.phone ? userDetailsMap[flat.ownerUid]?.phone : ""}`}
                        className="flex items-center justify-center bg-blue-100 text-blue-700 rounded-full shadow hover:bg-blue-200 transition w-10 h-10"
                        title="Call Owner"
                      >
                      ...
                      <a
                        href={`https://wa.me/${flat.ownerUid && userDetailsMap[flat.ownerUid]?.phone ? userDetailsMap[flat.ownerUid]?.phone?.replace(/\D/g, "") : ""}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center bg-green-100 text-green-700 rounded-full shadow hover:bg-green-200 transition w-10 h-10"
                  ...
                  {flat.status === "rented" && (
                    <div className="flex flex-col items-center w-full mt-1">
                      <div className="flex items-center justify-center gap-x-2 w-full">
                        ...
                        <span
                          className="text-sm font-medium text-blue-900 mr-2 truncate max-w-[80px]"
                          title={flat.tenantUid && userDetailsMap[flat.tenantUid]?.name ? userDetailsMap[flat.tenantUid]?.name : flat.tenantUid || ""}
                        >
                      ...
                      <div className="flex flex-row items-center justify-center gap-x-2 mt-1 w-full">
                        ...
                        <a
                          href={`tel:${flat.tenantUid && userDetailsMap[flat.tenantUid]?.phone ? userDetailsMap[flat.tenantUid]?.phone : ""}`}
                          className="flex items-center justify-center bg-blue-100 text-blue-700 rounded-full shadow hover:bg-blue-200 transition w-10 h-10"
                          title="Call Tenant"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                        ...
                        <a
                          href={`https://wa.me/${flat.tenantUid && userDetailsMap[flat.tenantUid]?.phone ? userDetailsMap[flat.tenantUid]?.phone?.replace(/\D/g, "") : ""}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="flex items-center justify-center bg-green-100 text-green-700 rounded-full shadow hover:bg-green-200 transition w-10 h-10"
